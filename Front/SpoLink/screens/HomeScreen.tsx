  ...
  >
    ...
    {selectedSports.map((sport) => (
      <TouchableOpacity
        key={`sport-${sport}`}
        onPress={() => toggleSport(sport)}
        style={[styles.chip, { backgroundColor: '#d0ebff' }]}
      >
        <Text style={[styles.chipText, { color: '#0077b6' }]}>{sport} ✕</Text>
      </TouchableOpacity>
    ))}
    ...
    {selectedAges.map((age) => (
      <TouchableOpacity
        ...
        style={[styles.chip, { backgroundColor: '#d0ebff' }]}
      >
        <Text style={[styles.chipText, { color: '#0077b6'}]}>{age} ✕</Text>
      </TouchableOpacity>
    ))}
    ...
    <TouchableOpacity
      ...
      style={[styles.chip, { backgroundColor: '#ffe8e8' }]}
    >
